...
use crabgo::ops::{self, CleanOptions};
use crabgo::util::print_available_packages;

pub fn cli() -> Command {
    subcommand("clean")
        .about("Remove artifacts that crabgo has generated in the past")
        .arg_quiet()
        ...
        .after_help("Run `crabgo help clean` for more detailed information.\n")
}
