...
use crabgo::core::compiler::future_incompat::{OnDiskReports, REPORT_PREAMBLE};
use crabgo::drop_println;

pub fn cli() -> Command {
    subcommand("report")
        .about("Generate and display various kinds of reports")
        .after_help("Run `crabgo help report` for more detailed information.\n")
        ...
        .subcommand(
            subcommand("future-incompatibilities")
                ...
                .arg(
                    opt(
                        "id",
                        "identifier of the report generated by a Crabgo command invocation",
                    )
                    .value_name("id"),
                )
