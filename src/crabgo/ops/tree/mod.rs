...
/// Entry point for the `crabgo tree` command.
pub fn build_and_print(ws: &Workspace<'_>, opts: &TreeOptions) -> CrabgoResult<()> {
    ...
    let root_specs = if opts.invert.is_empty() {
        ...
        opts.invert
            ...
            .collect::<CrabgoResult<Vec<PackageIdSpec>>>()?
    };
