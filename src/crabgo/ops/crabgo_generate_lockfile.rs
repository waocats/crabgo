...
pub fn generate_lockfile(ws: &Workspace<'_>) -> CrabgoResult<()> {
...
pub fn update_lockfile(ws: &Workspace<'_>, opts: &UpdateOptions<'_>) -> CrabgoResult<()> {
    ...
    // that we're synchronized against other Crabgos.
