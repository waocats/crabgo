//! # An internal profiler for Crabgo itself
//!
//! > **Note**: This might not be the module you are looking for.
//! > For information about how Crabgo handles compiler flags with profiles,
//! > please see the module [`crabgo::core::profiles`](crate::core::profiles).
