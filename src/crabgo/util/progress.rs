...
impl<'cfg> Progress<'cfg> {
    ...
    /// quickly.
    pub fn tick(&mut self, cur: usize, max: usize, msg: &str) -> CrabgoResult<()> {
    ...
    pub fn tick_now(&mut self, cur: usize, max: usize, msg: &str) -> CrabgoResult<()> {
        match self.state {
    ...
    pub fn print_now(&mut self, msg: &str) -> CrabgoResult<()> {
        match &mut self.state {
            Some(s) => s.print("", msg),
            None => Ok(()),
        }
...
impl<'cfg> State<'cfg> {
    fn tick(&mut self, cur: usize, max: usize, msg: &str) -> CrabgoResult<()> {
        if self.done {
            return Ok(());
        }
    ...
    fn print(&mut self, prefix: &str, msg: &str) -> CrabgoResult<()> {
