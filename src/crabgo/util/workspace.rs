...
pub fn print_available_packages(ws: &Workspace<'_>) -> CrabgoResult<()> {
    let packages = ws
        .members()
...
pub fn print_available_examples(ws: &Workspace<'_>, options: &CompileOptions) -> CrabgoResult<()> {
    print_available_targets(Target::is_example, ws, options, "--example", "examples")
}

pub fn print_available_binaries(ws: &Workspace<'_>, options: &CompileOptions) -> CrabgoResult<()> {
    print_available_targets(Target::is_bin, ws, options, "--bin", "binaries")
}

pub fn print_available_benches(ws: &Workspace<'_>, options: &CompileOptions) -> CrabgoResult<()> {
    print_available_targets(Target::is_bench, ws, options, "--bench", "benches")
}

pub fn print_available_tests(ws: &Workspace<'_>, options: &CompileOptions) -> CrabgoResult<()> {
...
///
/// In general users don't expect `crabgo build` to cause rebuilds if you change
