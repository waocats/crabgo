...
/// An artifact with this name will conflict with one of Crabgo's build directories.
...
/// elsewhere. `crabgo new` has a few restrictions, such as checking for
/// reserved names. crates.io has even more restrictions.
pub fn validate_package_name(name: &str, what: &str, help: &str) -> CrabgoResult<()> {
