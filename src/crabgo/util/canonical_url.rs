...
/// Crabgo. It's to help paper over mistakes such as depending on
/// `github.com/foo/bar` vs `github.com/foo/bar.git`. This is **only** for
/// internal purposes within Crabgo and provides no means to actually read the
...
impl CanonicalUrl {
    pub fn new(url: &Url) -> CrabgoResult<CanonicalUrl> {
