//! Code for representing crabgo's release version number.

use std::fmt;

/// Information about the git repository where crabgo was built from.
...
pub struct VersionInfo {
    /// Crabgo's version, such as "1.57.0", "1.58.0-beta.1", "1.59.0-nightly", etc.
    pub version: String,
...
/// Returns information about crabgo's version.
pub fn version() -> VersionInfo {
    ...
    let version = option_env_str!("CFG_RELEASE").unwrap_or_else(|| {
        // If crabgo is not being built by rustbuild, then we just use the
        // version from crabgo's own `Crabgo.toml`.
        //
        // There are two versions at play here:
        //   - version of crabgo-the-binary, which you see when you type `crabgo --version`
        //   - version of crabgo-the-library, which you download from crates.io for use
        //     in your packages.
        //
        ...
        //
        // Coincidentally, the minor version for crabgo-the-library is always
