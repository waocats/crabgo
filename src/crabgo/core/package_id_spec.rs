...
impl PackageIdSpec {
    ...
    /// }
    pub fn parse(spec: &str) -> CrabgoResult<PackageIdSpec> {
        if spec.contains("://") {
    ...
    pub fn query_str<I>(spec: &str, i: I) -> CrabgoResult<PackageId>
    where
    ...
    fn from_url(mut url: Url) -> CrabgoResult<PackageIdSpec> {
    ...
    pub fn query<I>(&self, i: I) -> CrabgoResult<PackageId>
    where
        I: IntoIterator<Item = PackageId>,
    {
