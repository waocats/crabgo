...
/// Checks features for errors, bailing out a CrabgoResult:Err if invalid,
...
fn validate_feature_name(config: &Config, pkg_id: PackageId, name: &str) -> CrabgoResult<()> {
    let mut chars = name.chars();
    const FUTURE: &str = "This was previously accepted but is being phased out; \
        it will become a hard error in a future release.\n\
        For more information, see issue #8813 <https://github.com/rust-lang/crabgo/issues/8813>, \
