...
pub struct ResolverProgress {
    ...
    /// testing Crabgo itself.
    /// See [rust-lang/crabgo#6596](https://github.com/rust-lang/crabgo/pull/6596) for more.
...
impl ResolverProgress {
    ...
    pub fn shell_status(&mut self, config: Option<&Config>) -> CrabgoResult<()> {
...
impl ResolveBehavior {
    pub fn from_manifest(resolver: &str) -> CrabgoResult<ResolveBehavior> {
        match resolver {
...
pub struct ResolveOpts {
    ...
    ///
    /// This may be set to `false` by things like `crabgo install` or `-Z avoid-dev-deps`.
