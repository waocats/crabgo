...
///
/// A unit is an object that has enough information so that crabgo knows how to build it.
...
impl Unit {
    ...
    ///
    /// [`-Zbuild-plan`]: https://doc.rust-lang.org/nightly/crabgo/reference/unstable.html#build-plan
