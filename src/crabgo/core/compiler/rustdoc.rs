...
use crate::util::errors::{internal, CrabgoResult};
...
///
/// [1]: https://doc.rust-lang.org/nightly/crabgo/reference/unstable.html#rustdoc-map
#[derive(Debug, Hash)]
...
/// [2]: https://doc.rust-lang.org/nightly/crabgo/reference/unstable.html#rustdoc-map
...
/// Configured within Crabgo.toml and only for unstable feature
/// [`-Zrustdoc-scrape-examples`][1].
///
/// [1]: https://doc.rust-lang.org/nightly/crabgo/reference/unstable.html#scrape-examples
...
impl BuildContext<'_, '_> {
    ...
    /// A plain old `crabgo doc` would just die if a build script execution fails,
