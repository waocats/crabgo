...
impl<'a, 'cfg> BuildContext<'a, 'cfg> {
    ...
    ///
    /// Although it depends on the caller, in the current Crabgo implementation,
    ...
    /// See [`TargetInfo.rustflags`] for more on how Crabgo collects them.
    ///
    ...
    ///
    /// As of now, these flags come from environment variables and configurations.
    /// See [`TargetInfo.rustdocflags`] for more on how Crabgo collects them.
    ///
