...
/// (see [rust-lang/crabgo#4978]). However, `links` has been around since 2014,
...
///
/// [rust-lang/crabgo#4978]: https://github.com/rust-lang/crabgo/pull/4978
/// [`package.links`]: https://doc.rust-lang.org/nightly/crabgo/reference/build-scripts.html#the-links-manifest-key
pub fn validate_links(resolve: &Resolve, unit_graph: &UnitGraph) -> CrabgoResult<()> {
