...
<dl>
<dt class="option-term" id="option-crabgo-fetch---target"><a class="option-anchor" href="#option-crabgo-fetch---target"></a><code>--target</code> <em>triple</em></dt>
...
<dl>
<dt class="option-term" id="option-crabgo-fetch--v"><a class="option-anchor" href="#option-crabgo-fetch--v"></a><code>-v</code></dt>
<dt class="option-term" id="option-crabgo-fetch---verbose"><a class="option-anchor" href="#option-crabgo-fetch---verbose"></a><code>--verbose</code></dt>
...
<dt class="option-term" id="option-crabgo-fetch--q"><a class="option-anchor" href="#option-crabgo-fetch--q"></a><code>-q</code></dt>
<dt class="option-term" id="option-crabgo-fetch---quiet"><a class="option-anchor" href="#option-crabgo-fetch---quiet"></a><code>--quiet</code></dt>
<dd class="option-desc">Do not print crabgo log messages.
May also be specified with the <code>term.quiet</code>
<a href="../reference/config.html">config value</a>.</dd>


<dt class="option-term" id="option-crabgo-fetch---color"><a class="option-anchor" href="#option-crabgo-fetch---color"></a><code>--color</code> <em>when</em></dt>
...
<dl>
<dt class="option-term" id="option-crabgo-fetch---manifest-path"><a class="option-anchor" href="#option-crabgo-fetch---manifest-path"></a><code>--manifest-path</code> <em>path</em></dt>
...
<dt class="option-term" id="option-crabgo-fetch---frozen"><a class="option-anchor" href="#option-crabgo-fetch---frozen"></a><code>--frozen</code></dt>
<dt class="option-term" id="option-crabgo-fetch---locked"><a class="option-anchor" href="#option-crabgo-fetch---locked"></a><code>--locked</code></dt>
...
<dt class="option-term" id="option-crabgo-fetch---offline"><a class="option-anchor" href="#option-crabgo-fetch---offline"></a><code>--offline</code></dt>
...
<dt class="option-term" id="option-crabgo-fetch-+toolchain"><a class="option-anchor" href="#option-crabgo-fetch-+toolchain"></a><code>+</code><em>toolchain</em></dt>
...
<dt class="option-term" id="option-crabgo-fetch---config"><a class="option-anchor" href="#option-crabgo-fetch---config"></a><code>--config</code> <em>KEY=VALUE</em> or <em>PATH</em></dt>
...
<dt class="option-term" id="option-crabgo-fetch--C"><a class="option-anchor" href="#option-crabgo-fetch--C"></a><code>-C</code> <em>PATH</em></dt>
...
<dt class="option-term" id="option-crabgo-fetch--h"><a class="option-anchor" href="#option-crabgo-fetch--h"></a><code>-h</code></dt>
<dt class="option-term" id="option-crabgo-fetch---help"><a class="option-anchor" href="#option-crabgo-fetch---help"></a><code>--help</code></dt>
<dd class="option-desc">Prints help information.</dd>


<dt class="option-term" id="option-crabgo-fetch--Z"><a class="option-anchor" href="#option-crabgo-fetch--Z"></a><code>-Z</code> <em>flag</em></dt>
...
## SEE ALSO
[crabgo(1)](crabgo.html), [crabgo-update(1)](crabgo-update.html), [crabgo-generate-lockfile(1)](crabgo-generate-lockfile.html)
