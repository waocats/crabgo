//! Platform definition used by Crabgo.
//!
//! This defines a [`Platform`] type which is used in Crabgo to specify a target platform.
                    ...
                    Cfg::KeyPair(name, _) => if name.as_str() == "feature" {
                        warnings.push(String::from(
                            "Found `feature = ...` in `target.'cfg(...)'.dependencies`. \
                             ...
                             https://doc.rust-lang.org/crabgo/reference/features.html"
                        ))
                    },
                }
            }
