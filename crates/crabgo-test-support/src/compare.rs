...
//!   `[WARNING]`) to match crabgo's "status" output and allows you to ignore
...
//!   Tests that work around [issue 7358](https://github.com/rust-lang/crabgo/issues/7358)
...
/// (e.g., rustc) rather than Crabgo itself).
