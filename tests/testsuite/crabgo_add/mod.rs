...
fn init_alt_registry() {
    crabgo_test_support::registry::alt_init();
...
fn add_registry_packages(alt: bool) {
    for name in [
        ...
        "toml",
        "versioned-package",
        "crabgo-list-test-fixture-dependency",
        "unrelateed-crate",
    ] {
        crabgo_test_support::registry::Package::new(name, "0.1.1+my-package")
            .alternative(alt)
            .publish();
        crabgo_test_support::registry::Package::new(name, "0.2.0+my-package")
            .alternative(alt)
            .publish();
        crabgo_test_support::registry::Package::new(name, "0.2.3+my-package")
            .alternative(alt)
            .publish();
        crabgo_test_support::registry::Package::new(name, "0.4.1+my-package")
            .alternative(alt)
            .publish();
        crabgo_test_support::registry::Package::new(name, "20.0.0+my-package")
            .alternative(alt)
            .publish();
        crabgo_test_support::registry::Package::new(name, "99999.0.0+my-package")
            .alternative(alt)
            .publish();
        crabgo_test_support::registry::Package::new(name, "99999.0.0-alpha.1+my-package")
            .alternative(alt)
            .publish();
    }

    crabgo_test_support::registry::Package::new("prerelease_only", "0.2.0-alpha.1")
        .alternative(alt)
        .publish();
    crabgo_test_support::registry::Package::new("test_breaking", "0.2.0")
        .alternative(alt)
        .publish();
    crabgo_test_support::registry::Package::new("test_nonbreaking", "0.1.1")
        .alternative(alt)
        .publish();
    crabgo_test_support::registry::Package::new("test_cyclic_features", "0.1.1")
        .alternative(alt)
    ...
    // Normalization
    crabgo_test_support::registry::Package::new("linked-hash-map", "0.5.4")
        .alternative(alt)
        .feature("clippy", &[])
        .feature("heapsize", &[])
        ...
        .feature("serde_test", &[])
        .publish();
    crabgo_test_support::registry::Package::new("inflector", "0.11.4")
        .alternative(alt)
    ...
    crabgo_test_support::registry::Package::new("your-face", "99999.0.0+my-package")
        .alternative(alt)
        .feature("nose", &[])
        .feature("mouth", &[])
        .feature("eyes", &[])
