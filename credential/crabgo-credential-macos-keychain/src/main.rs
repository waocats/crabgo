//! Crabgo registry macos keychain credential process.
...
mod macos {
    ...
    fn registry(registry_name: &str) -> String {
        format!("crabgo-registry:{}", registry_name)
    }
...
use crabgo_credential::UnsupportedCredential as MacKeychain;
#[cfg(target_os = "macos")]
use macos::MacKeychain;

fn main() {
    crabgo_credential::main(MacKeychain);
}
